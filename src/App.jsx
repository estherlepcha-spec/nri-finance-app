      ...
      <div style={{ width: '100%', maxWidth: 460 }}>
        <div style={{ textAlign: 'center', marginBottom: 28 }}>
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: 12, marginBottom: 12 }}>
            <img src="/app-logo-v5.png" alt="logo" style={{ width: 42, height: 42, borderRadius: 10, objectFit: 'contain', filter: 'drop-shadow(0 2px 8px rgba(255,136,0,0.4))' }} />
    ...
    <div style={{ display: 'flex', height: '100vh', background: C.bg, color: C.text, overflow: 'hidden' }}>
      ...
      <aside className="sidebar" style={{ width: 232, background: C.card, borderRight: `1px solid ${C.border}` }}>
        ...
        <div style={{ padding: '18px 18px 14px', borderBottom: `1px solid ${C.border}`, flexShrink: 0 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 10 }}>
            {/* App Logo */}
            <img src="/app-logo-v5.png" alt="NRI's & Expat's" style={{ width: 36, height: 36, borderRadius: 8, flexShrink: 0, objectFit: 'contain', filter: 'drop-shadow(0 2px 6px rgba(255,136,0,0.4))' }} />
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden', minWidth: 0 }}>
        ...
        <div className="mobile-topbar">
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            <img src="/app-logo-v5.png" alt="logo" style={{ width: 28, height: 28, borderRadius: 7, objectFit: 'contain', filter: 'drop-shadow(0 1px 5px rgba(255,136,0,0.4))' }} />
            <div>
        ...
        <>
          ...
          <div className="hamburger-drawer">
            <div style={{ padding: '16px 18px 12px', borderBottom: `1px solid ${C.border}`, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                <img src="/app-logo-v5.png" alt="logo" style={{ width: 32, height: 32, borderRadius: 8, objectFit: 'contain', filter: 'drop-shadow(0 2px 6px rgba(255,136,0,0.4))' }} />
                <div>
                  <div style={{ fontSize: 13, fontWeight: 800, color: C.text, letterSpacing: '-0.02em', lineHeight: 1.25 }}>NRI's & Expat's</div>
                  <div style={{ fontSize: 9, color: C.muted, letterSpacing: '0.04em' }}>Personal Finance</div>
                </div>
