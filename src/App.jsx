      ...
      <div style={{ width: '100%', maxWidth: 460 }}>
        <div style={{ textAlign: 'center', marginBottom: 28 }}>
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: 12, marginBottom: 12 }}>
            <div role="img" aria-label="logo" style={{ width: 72, height: 72, flexShrink: 0, borderRadius: 16, backgroundImage: 'url(/app-logo-v5.png)', backgroundSize: '130%', backgroundPosition: '51% 30%', backgroundRepeat: 'no-repeat', filter: 'drop-shadow(0 3px 14px rgba(255,136,0,0.55))' }} />
    ...
    <div style={{ display: 'flex', height: '100vh', background: C.bg, color: C.text, overflow: 'hidden' }}>
      ...
      <aside className="sidebar" style={{ width: 232, background: C.card, borderRight: `1px solid ${C.border}` }}>
        ...
        <div style={{ padding: '18px 18px 14px', borderBottom: `1px solid ${C.border}`, flexShrink: 0 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 10 }}>
            {/* App Logo */}
            <div role="img" aria-label="NRI's & Expat's" style={{ width: 64, height: 64, flexShrink: 0, borderRadius: 14, backgroundImage: 'url(/app-logo-v5.png)', backgroundSize: '130%', backgroundPosition: '51% 30%', backgroundRepeat: 'no-repeat', filter: 'drop-shadow(0 3px 14px rgba(255,136,0,0.6))' }} />
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden', minWidth: 0 }}>
        ...
        <div className="mobile-topbar">
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            <div role="img" aria-label="logo" style={{ width: 52, height: 52, flexShrink: 0, borderRadius: 12, backgroundImage: 'url(/app-logo-v5.png)', backgroundSize: '130%', backgroundPosition: '51% 30%', backgroundRepeat: 'no-repeat', filter: 'drop-shadow(0 2px 10px rgba(255,136,0,0.5))' }} />
            <div>
        ...
        <>
          ...
          <div className="hamburger-drawer">
            <div style={{ padding: '16px 18px 12px', borderBottom: `1px solid ${C.border}`, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                <div role="img" aria-label="logo" style={{ width: 56, height: 56, flexShrink: 0, borderRadius: 12, backgroundImage: 'url(/app-logo-v5.png)', backgroundSize: '130%', backgroundPosition: '51% 30%', backgroundRepeat: 'no-repeat', filter: 'drop-shadow(0 2px 10px rgba(255,136,0,0.5))' }} />
                <div>
                  <div style={{ fontSize: 13, fontWeight: 800, color: C.text, letterSpacing: '-0.02em', lineHeight: 1.25 }}>NRI's & Expat's</div>
                  <div style={{ fontSize: 9, color: C.muted, letterSpacing: '0.04em' }}>Personal Finance</div>
